...
# Go through the number of epochs
    ...
    for subset_name, subset_indx in zip(subset_names, subset_indices_list):
        ...
        metrics_per_subset[subset_name]['F1']['Fungi'][fold]=f1
        metrics_per_subset[subset_name]['Recall']['Fungi'][fold]=recall
        metrics_per_subset[subset_name]['Precision']['Fungi'][fold]=precision
        metrics_per_subset[subset_name]['BA']['Fungi'][fold]=BA
        metrics_per_subset[subset_name]['ACC']['Fungi'][fold]=accuracy
        metrics_per_subset[subset_name]['AUC']['Fungi'][fold]=auc
...
if __name__ == "__main__":
    ...
    """
    dataset = CorneaUnifespDataset(transform=transform,classification='fungi')
