...
# Go through the number of epochs
    ...
    for subset_name, subset_indx in zip(subset_names, subset_indices_list):
        ...
        metrics_per_subset[subset_name]['F1']['Bacteria'][fold]=f1
        metrics_per_subset[subset_name]['Recall']['Bacteria'][fold]=recall
        metrics_per_subset[subset_name]['Precision']['Bacteria'][fold]=precision
        metrics_per_subset[subset_name]['BA']['Bacteria'][fold]=BA
        metrics_per_subset[subset_name]['ACC']['Bacteria'][fold]=accuracy
        metrics_per_subset[subset_name]['AUC']['Bacteria'][fold]=auc
...
if __name__ == "__main__":
    ...
    # CLI
    parser = argparse.ArgumentParser(description='baseline_bacteria.py')
    ...
    """
    dataset = CorneaUnifespDataset(transform=transform,classification='bacteria')
    # Hyperparameters and training settings
    num_classes = args.num_classes
    epochs = args.epochs
    model_names = args.model_names
    analysis='bacteria_final'
    print(analysis)
    fold_info=[]
    """
